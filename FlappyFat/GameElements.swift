...
//  FlappyFat
//
//  Created by Const. on 20.06.2018.
//  Copyright © 2018 Oleginc. All rights reserved.
//
...
extension GameScene {
    ...
    func createHighscoreLabel() -> SKLabelNode {
        ...
        if let highestScore = UserDefaults.standard.object(forKey: "highestScore"){
            highscoreLbl.text = "Рекорд: \(highestScore)"
        } else {
            highscoreLbl.text = "Рекорд: 0"
        }
    ...
    func createTaptoplayLabel() -> SKLabelNode {
        ...
        taptoplayLbl.text = "Нажми шобы играть"
